...
- Dark UI with the tokens in `src/app/globals.css`; pink is the only accent; semantic success/warning/danger colors are separate from it; rounded-2xl cards; readable at 400 px; lucide-react icons, no emoji as icons.
