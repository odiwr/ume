...
export const CEO_NAV: readonly CeoNavItem[] = [
  {
    ...
    label: 'Overview',
    icon: 'overview',
    description: 'Key numbers across the whole product.',
  },
  {
    href: '/ceo/workspaces',
    label: 'Workspaces',
    icon: 'workspaces',
    description: 'Every Discord server that has met the bot.',
  },
  {
    href: '/ceo/users',
    label: 'Users',
    icon: 'users',
    description: 'Accounts, Discord links and bans.',
  },
  {
    href: '/ceo/storage',
    label: 'Storage',
    icon: 'storage',
    description: 'Who is using the bytes.',
  },
  {
    href: '/ceo/revenue',
    label: 'Revenue',
    icon: 'revenue',
    description: 'Paid workspaces and MRR.',
  },
  {
    href: '/ceo/bot',
    label: 'Bot health',
    icon: 'bot',
    description: 'Heartbeats and voice presence per server.',
  },
  { href: '/ceo/flags', label: 'Flags', icon: 'flags', description: 'Global kill-switches.' },
  {
    ...
    label: 'DMCA',
    icon: 'dmca',
    description: 'Takedown notices and counter-notices.',
  },
  {
    href: '/ceo/notifications',
    label: 'Notifications',
    icon: 'notifications',
    description: 'Outbound email and Discord messages.',
  },
